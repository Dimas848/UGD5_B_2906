    ...
    <AuthFormWrapper title="Register">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 w-full">
        ...
        <div className="space-y-2">
          ...
          />
          {errors.username && <p className="text-red-600 text-sm italic mt-1">{errors.username.message as string}</p>}
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          {errors.email && <p className="text-red-600 text-sm italic mt-1">{errors.email.message as string}</p>}
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          {errors.nomorTelp && <p className="text-red-600 text-sm italic mt-1">{errors.nomorTelp.message as string}</p>}
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          {errors.password && <p className="text-red-600 text-sm italic mt-1">{errors.password.message as string}</p>}
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          {errors.confirmPassword && <p className="text-red-600 text-sm italic mt-1">{errors.confirmPassword.message as string}</p>}
        </div>
